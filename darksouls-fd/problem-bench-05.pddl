...
(define (problem bench-05-fd)
  ...
  (:init
    ...
    (hp-after-attack armored-boss hp10 hp9)
    (hp-after-attack armored-boss hp9 hp8)
    (hp-after-attack armored-boss hp8 hp7)
    (hp-after-attack armored-boss hp7 hp6)
    (hp-after-attack armored-boss hp6 hp5)
    (hp-after-attack armored-boss hp5 hp4)
    ...
    (hp-after-attack miner hp10 hp9)
    (hp-after-attack miner hp9 hp8)
    (hp-after-attack miner hp8 hp7)
    (hp-after-attack miner hp7 hp6)
    (hp-after-attack miner hp6 hp5)
    (hp-after-attack miner hp5 hp4)
    ...
    (soul-after-drop miner s7 s9)
    (soul-after-drop miner s8 s9)
    (soul-after-drop miner s9 s9)
    ...
    (soul-after-drop armored-boss s6 s9)
    (soul-after-drop armored-boss s7 s9)
    (soul-after-drop armored-boss s8 s9)
    (soul-after-drop armored-boss s9 s9)
