...
(define (problem darksouls-fd-p01-tutorial)
  ...
  (:init
    ...
    (hp-zero hp0)
    (hp-heal hp0 hp0 hp0)
    (hp-heal hp15 hp0 hp15) (hp-heal hp15 hp15 hp15)
    (hp-heal hp30 hp0 hp30) (hp-heal hp30 hp15 hp30) (hp-heal hp30 hp30 hp30)
    (hp-heal hp45 hp0 hp45) (hp-heal hp45 hp15 hp45) (hp-heal hp45 hp30 hp45) (hp-heal hp45 hp45 hp45)
    (hp-heal hp60 hp0 hp60) (hp-heal hp60 hp15 hp60) (hp-heal hp60 hp30 hp60) (hp-heal hp60 hp45 hp60) (hp-heal hp60 hp60 hp60)
    (hp-heal hp75 hp0 hp75) (hp-heal hp75 hp15 hp75) (hp-heal hp75 hp30 hp75) (hp-heal hp75 hp45 hp75) (hp-heal hp75 hp60 hp75) (hp-heal hp75 hp75 hp75)
    (hp-heal hp90 hp0 hp75) (hp-heal hp90 hp15 hp90) (hp-heal hp90 hp30 hp90) (hp-heal hp90 hp45 hp90) (hp-heal hp90 hp60 hp90) (hp-heal hp90 hp75 hp90) (hp-heal hp90 hp90 hp90)
    (hp-heal hp105 hp0 hp75) (hp-heal hp105 hp15 hp90) (hp-heal hp105 hp30 hp105) (hp-heal hp105 hp45 hp105) (hp-heal hp105 hp60 hp105) (hp-heal hp105 hp75 hp105) (hp-heal hp105 hp90 hp105) (hp-heal hp105 hp105 hp105)
    (hp-heal hp120 hp0 hp75) (hp-heal hp120 hp15 hp90) (hp-heal hp120 hp30 hp105) (hp-heal hp120 hp45 hp120) (hp-heal hp120 hp60 hp120) (hp-heal hp120 hp75 hp120) (hp-heal hp120 hp90 hp120) (hp-heal hp120 hp105 hp120) (hp-heal hp120 hp120 hp120)
    (hp-heal hp135 hp0 hp75) (hp-heal hp135 hp15 hp90) (hp-heal hp135 hp30 hp105) (hp-heal hp135 hp45 hp120) (hp-heal hp135 hp60 hp135) (hp-heal hp135 hp75 hp135) (hp-heal hp135 hp90 hp135) (hp-heal hp135 hp105 hp135) (hp-heal hp135 hp120 hp135) (hp-heal hp135 hp135 hp135)
    (hp-heal hp150 hp0 hp75) (hp-heal hp150 hp15 hp90) (hp-heal hp150 hp30 hp105) (hp-heal hp150 hp45 hp120) (hp-heal hp150 hp60 hp135) (hp-heal hp150 hp75 hp150) (hp-heal hp150 hp90 hp150) (hp-heal hp150 hp105 hp150) (hp-heal hp150 hp120 hp150) (hp-heal hp150 hp135 hp150) (hp-heal hp150 hp150 hp150)
