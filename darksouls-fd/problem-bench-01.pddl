...
(define (problem bench-01-fd)
  ...
  (:init
    ...
    (hp-after-attack tutorial-boss hp10 hp9)
    (hp-after-attack tutorial-boss hp9 hp8)
    (hp-after-attack tutorial-boss hp8 hp7)
    (hp-after-attack tutorial-boss hp7 hp6)
    (hp-after-attack tutorial-boss hp6 hp5)
    ...
    (soul-next s5 s6) (soul-next s6 s7) (soul-next s7 s8) (soul-next s8 s9)
    (player-max-souls s9)
    (soul-min s0)
    (player-souls s0)
    ...
    (soul-after-drop tutorial-boss s3 s6)
    (soul-after-drop tutorial-boss s4 s7)
    (soul-after-drop tutorial-boss s5 s8)
    (soul-after-drop tutorial-boss s6 s9)
    (soul-after-drop tutorial-boss s7 s9)
    (soul-after-drop tutorial-boss s8 s9)
    (soul-after-drop tutorial-boss s9 s9)
